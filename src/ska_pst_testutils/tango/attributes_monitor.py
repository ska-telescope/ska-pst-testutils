...
class _AttributeHistory:
    ...
    def update_value(self: _AttributeHistory, value: Any) -> None:
...
class AttributesMonitor:
    ...
    def _handle_attribute_event(
        self: AttributesMonitor, attribute: str, attribute_value: Any, *args: Any, **kwargs: Any
    ) -> None:
        ...
        attr_history.update_value(attribute_value)
